...
export function SearchBar() {
  ...
  return (
    <div ref={searchRef} className="w-full max-w-xl mx-auto relative z-10">
      ...
      {showResults && (
        <div className="absolute mt-2 w-full bg-black/90 backdrop-blur-md rounded-2xl shadow-2xl z-50 overflow-hidden border border-gray-800 transition-all duration-300 animate-fadeIn">
